...
function valida_campo($campo) {
    ...
    // ENT_SUBSTITUTE sustituye los caracteres inválidos en entorno UTF-8 por símbolos seguros para que en lugar de romperse, la app se siga cargando con normalidad
}
